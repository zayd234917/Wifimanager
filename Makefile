#############################################################################
# Makefile for building: Wifi_Manager
# Generated by qmake (3.1) (Qt 5.15.16)
# Project:  Wifi_Manager.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Wifi_Manager.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Wifi_Manager1.0.0
DISTDIR = /home/lagro/Documents/wifi_manager/Wifi_Manager/.tmp/Wifi_Manager1.0.0
LINK          = g++
...
SOURCES       = main.cpp \
		wifimanager.cpp moc_wifimanager.cpp
OBJECTS       = main.o \
		wifimanager.o \
		moc_wifimanager.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Wifi_Manager.pro wifimanager.h main.cpp \
		wifimanager.cpp
QMAKE_TARGET  = Wifi_Manager
DESTDIR       = 
TARGET        = Wifi_Manager
...
Wifi_Manager: ui_wifimanager.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Wifi_Manager.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		Wifi_Manager.pro
	$(QMAKE) -o Makefile Wifi_Manager.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents wifimanager.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp wifimanager.cpp $(DISTDIR)/
	$(COPY_FILE) --parents wifimanager.ui $(DISTDIR)/
...
compiler_moc_header_make_all: moc_wifimanager.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_wifimanager.cpp
moc_wifimanager.cpp: wifimanager.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/lagro/Documents/wifi_manager/Wifi_Manager/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/lagro/Documents/wifi_manager/Wifi_Manager -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/14.2.1 -I/usr/include/c++/14.2.1/x86_64-pc-linux-gnu -I/usr/include/c++/14.2.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/14.2.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/14.2.1/include-fixed -I/usr/include wifimanager.h -o moc_wifimanager.cpp

compiler_moc_objc_header_make_all:
compiler_moc_objc_header_clean:
compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_wifimanager.h
compiler_uic_clean:
	-$(DEL_FILE) ui_wifimanager.h
ui_wifimanager.h: wifimanager.ui \
		/usr/bin/uic
	/usr/bin/uic wifimanager.ui -o ui_wifimanager.h
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/Wifi_Manager/bin || mkdir -p $(INSTALL_ROOT)/opt/Wifi_Manager/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/Wifi_Manager/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/Wifi_Manager/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/Wifi_Manager/bin/ 
